(function () {
    ...
    function applyDisplaySettings() {
        ...
        style.setProperty('--qc-evaluation-photo-width', evaluationPhotoWidth + '%');
        style.setProperty('--qc-evaluation-detail-width', (100 - evaluationPhotoWidth) + '%');
        style.setProperty('--qc-evaluation-header-padding-x', evaluationHeaderPaddingX + 'px');
        style.setProperty('--qc-evaluation-header-padding-y', evaluationHeaderPaddingY + 'px');
        style.setProperty('--qc-evaluation-heading-gap', Math.max(10, Math.round(evaluationHeaderPaddingX * 0.8)) + 'px');
        style.setProperty('--qc-evaluation-badge-padding-x', Math.max(8, Math.round(evaluationHeaderPaddingX * 0.7)) + 'px');
        style.setProperty('--qc-evaluation-badge-padding-y', Math.max(5, Math.round(evaluationHeaderPaddingY * 0.65)) + 'px');
        style.setProperty('--qc-evaluation-panel-padding', evaluationPanelPadding + 'px');
        style.setProperty('--qc-evaluation-section-gap', Math.max(6, Math.round(evaluationPanelPadding * 0.75)) + 'px');
        style.setProperty('--qc-evaluation-card-gap', Math.max(5, Math.round(evaluationPanelPadding * 0.55)) + 'px');
        style.setProperty('--qc-evaluation-card-padding', Math.max(7, Math.round(evaluationPanelPadding * 0.65)) + 'px');
